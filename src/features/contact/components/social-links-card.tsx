...
const SocialLinksCard = ({ socials }: SocialLinksCardProps) => {
  return (
    <div className="flex flex-col justify-between rounded-2xl border border-border bg-muted/30 p-8 shadow-lg shadow-primary/5 md:col-span-1 md:row-span-1 md:p-10">
